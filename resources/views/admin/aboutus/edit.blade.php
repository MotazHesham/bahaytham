    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.aboutus.update", [$aboutu->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $aboutu->description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mission') ? 'is-invalid' : '' }}" type="text" name="mission" id="mission" value="{{ old('mission', $aboutu->mission) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vision') ? 'is-invalid' : '' }}" type="text" name="vision" id="vision" value="{{ old('vision', $aboutu->vision) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('keywords_seo') ? 'is-invalid' : '' }}" name="keywords_seo" id="keywords_seo">{{ old('keywords_seo', $aboutu->keywords_seo) }}</textarea>
