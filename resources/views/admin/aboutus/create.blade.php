    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.aboutus.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('president_description') ? 'is-invalid' : '' }}" name="president_description" id="president_description">{{ old('president_description') }}</textarea>
