...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.update", [$project->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="owner">{{ trans('cruds.project.fields.owner') }}</label>
                <input class="form-control {{ $errors->has('owner') ? 'is-invalid' : '' }}" type="text" name="owner" id="owner" value="{{ old('owner', $project->owner) }}" required>
                @if($errors->has('owner'))
                    <div class="invalid-feedback">
                        {{ $errors->first('owner') }}
                    </div>
            ...
            <div class="form-group">
                <label class="required" for="working_area">{{ trans('cruds.project.fields.working_area') }}</label>
                <input class="form-control {{ $errors->has('working_area') ? 'is-invalid' : '' }}" type="text" name="working_area" id="working_area" value="{{ old('working_area', $project->working_area) }}" required>
                @if($errors->has('working_area'))
                    <div class="invalid-feedback">
                        {{ $errors->first('working_area') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.project.fields.working_area_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" name="meta_description" id="meta_description">{{ old('meta_description', $project->meta_description) }}</textarea>
