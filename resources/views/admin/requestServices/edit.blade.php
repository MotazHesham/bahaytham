    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.request-services.update", [$requestService->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('stages') ? 'is-invalid' : '' }}" name="stages" id="stages">
                    ...
                    @foreach(App\Models\RequestService::STAGES_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('stages', $requestService->stages) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $requestService->start_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $requestService->end_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('done_time') ? 'is-invalid' : '' }}" type="text" name="done_time" id="done_time" value="{{ old('done_time', $requestService->done_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_to_edit') ? 'is-invalid' : '' }}" type="text" name="duration_to_edit" id="duration_to_edit" value="{{ old('duration_to_edit', $requestService->duration_to_edit) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('consultant') ? 'is-invalid' : '' }}" name="consultant_id" id="consultant_id" required>
                    @foreach($consultants as $id => $entry)
                        <option value="{{ $id }}" {{ (old('consultant_id') ? old('consultant_id') : $requestService->consultant->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
