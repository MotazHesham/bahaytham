...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.said-about-uss.update', [$saidAboutUss->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('user') ? 'is-invalid' : '' }}" type="text" name="user"
                        id="user" value="{{ old('user', $saidAboutUss->user) }}" required>
                    @if ($errors->has('user'))
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('text') ? 'is-invalid' : '' }}" name="text" id="text" required>{{ old('text', $saidAboutUss->text) }}</textarea>
                    @if ($errors->has('text'))
                        <div class="invalid-feedback">
                            {{ $errors->first('text') }}
                        </div>
...
@section('scripts')
    <script>
        Dropzone.options.photoDropzone = {
            ...
            init: function() {
                @if (isset($saidAboutUss) && $saidAboutUss->photo)
                    var file = {!! json_encode($saidAboutUss->photo) !!}
