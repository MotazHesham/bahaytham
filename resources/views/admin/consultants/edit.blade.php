...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.consultants.update", [$consultant->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="description">{{ trans('cruds.consultant.fields.description') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $consultant->description) !!}</textarea>
            ...
            <div class="form-group">
                <label for="user_id">{{ trans('cruds.consultant.fields.user') }}</label>
